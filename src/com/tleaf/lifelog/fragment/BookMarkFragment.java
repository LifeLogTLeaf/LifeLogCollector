...
public class BookMarkFragment extends Fragment implements OnDataListener {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		rootView.findViewById(R.id.replication_start_btn).setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				// TODO Auto-generated method stub
				DbConnector db = new DbConnector(fragment, mContext.getApplicationContext());
				db.postData("young", "signup");
			}
		});
		
		rootView.findViewById(R.id.createdoc_btn).setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				// TODO Auto-generated method stub
				DbConnector db = new DbConnector(fragment, mContext.getApplicationContext());
