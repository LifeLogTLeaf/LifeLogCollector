...
public class ResponseConverter {
	...
	public Lifelog getLifelog( String document ) throws JSONException
	{
		...
		{
		case "bookmark" : return getBookmark( jsonobj );
		case "location" : return getLocation( jsonobj );
		case "call" 	: return getCall( jsonobj );
		case "photo" 	: return getPhoto( jsonobj );
		case "sms"		: return getSms( jsonobj );
		case "userinfo" : return getUserInfo( jsonobj );
		default : throw new JSONException("Lifelog Type is Invalid or String isn't a Lifelog");
		}
	...
	public UserInfo getUserInfo( JSONObject json ) throws JSONException
	{
		...
		userInfo.setUserFacebookUserInfor( 
				getFacebookUserInfo( json.getJSONObject("facebookuserinfor") ) );
		
		return userInfo;
	}
	
	public FacebookUserInfo getFacebookUserInfo( JSONObject json ) throws JSONException
	{
		FacebookUserInfo facebookuserInfo = new FacebookUserInfo();
		facebookuserInfo.setFacebookAccesskey( json.getString("facebookaccesskey") );
		facebookuserInfo.setFacebookId( json.getString("facebookid") );
		facebookuserInfo.setFacebookLastpostDate( json.getString("facebooklastpostdate") );
		facebookuserInfo.setFacebookLastUpdateDate( json.getString("facebooklastupdatedate") );
