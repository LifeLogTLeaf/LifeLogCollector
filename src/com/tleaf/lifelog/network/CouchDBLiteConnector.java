 ...
 */
public class CouchDBLiteConnector implements ChangeListener{
	private static final String TAG = "TOUCHDB CONNTECTOR";
	 ...
	 */
	public CouchDBLiteConnector(Context context) {
		try {
	...
	public void startReplication(String dbName) {
		...
		URL url = null;
		try {
			url = new URL("http://couchdb:dudwls@54.191.147.237:5984/young");
