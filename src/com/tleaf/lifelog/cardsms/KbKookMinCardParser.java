...
public class KbKookMinCardParser implements Parser{

	private Context mContext;

	public KbKookMinCardParser() {
	}

	public KbKookMinCardParser(Context context) {
		mContext = context;
	}
...
//			Mylog.i("파싱결과", cardSms.toString());
			Toast.makeText(mContext, "lifelog파싱cardsms\n" + cardSms.toString(), Toast.LENGTH_LONG).show();
