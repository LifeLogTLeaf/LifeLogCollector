...
import com.tleaf.lifelog.dbaccess.CouchDBAttach;
...
import com.tleaf.lifelog.util.WiFiListener;
import com.tleaf.lifelog.util.WiFiListener.OnChangeNetworkStatusListener;
			...
			try {
				...
				while (isWiFi) {
					...
					if (!arrFileList.isEmpty()) {
						CouchDBAttach couchDBTask = new CouchDBAttach(
